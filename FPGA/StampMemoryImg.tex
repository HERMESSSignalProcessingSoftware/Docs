...
%5 Weitere 48 bit busse
\coordinate (db1) at ($(compMemory) + (4.25cm, 3.0cm)$);
\path[blue, draw, line width = 5pt] (db1) -- node[above right]{48bit Datenbus} + (1.5cm,0cm) ;
\coordinate (db2) at ($(compMemory) + (4.25cm, 2.0cm)$);
\path[blue, draw, line width = 5pt] (db2) -- node[above right]{48bit Datenbus} + (1.5cm,0cm) ;
\coordinate (db3) at ($(compMemory) + (4.25cm, 1.0cm)$);
\path[blue, draw, line width = 5pt] (db3) -- node[above right]{48bit Datenbus} + (1.5cm,0cm) ;
\coordinate (db4) at ($(compMemory) + (4.25cm, 0.0cm)$);
\path[blue, draw, line width = 5pt] (db4) -- node[above right]{48bit Datenbus} + (1.5cm,0cm);
\coordinate (db5) at ($(compMemory) + (4.25cm, -1.0cm)$);
\path[blue, draw, line width = 5pt] (db5) -- node[above right]{48bit Datenbus} + (1.5cm,0cm) ;
