...
%Watchdog
\node[rectangle, draw, black, very thick, minimum height = 1cm, minimum width = 4.6cm, below of = compSoCCu , node distance = 3.5cm] (F1Watchdog) {Watchdog Statemachine };
\node[rectangle, draw, black, very thick, minimum height = 1cm, minimum width = 4.6cm, below of = F1Watchdog, node distance = 1.5cm] (F1WtdTimer) {AMBA Connector};
