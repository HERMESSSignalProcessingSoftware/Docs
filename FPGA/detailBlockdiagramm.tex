...
\path[blue, draw, line width = 5pt] (compDB) -- +(1.5cm,0cm) node[right]{64 bit Datenbus};
%Write enable
\coordinate (resetStatus) at ($(compStamp1) + (3.45cm, 3cm)$);
\path[blue, draw, line width = 2pt] (resetStatus) --+(1.5cm, 0cm) node[right]{Reset Status};
%Enable
...
\path[blue, draw, line width = 2pt] (drdycomp) -- +(1.3cm, 0cm) node[right]{New Avail};
%Amba bus
